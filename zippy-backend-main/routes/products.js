...
// Cloudinary configuration (reads from process.env with fallback defaults)
cloudinary.config({ 
  cloud_name: process.env.CLOUDINARY_CLOUD_NAME || 'duhokqw0j',
  api_key: process.env.CLOUDINARY_API_KEY || '736999584845369', 
  api_secret: process.env.CLOUDINARY_API_SECRET || 'rVgkQtDvgghhadMoQNoxuiw4bUI' 
});
